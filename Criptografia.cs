...
#region Variáveis e Métodos Privados
    ...
    public virtual string Encrypt(string texto) {
      ...
      return Cifrar(Convert.ToBase64String(cryptoByte, 0, cryptoByte.GetLength(0)));
    }
    ...
    public virtual string Decrypt(string textoCriptografado) {
      ...
      textoCriptografado = Descifrar(textoCriptografado);
    ...
    private string Cifrar(string texto) {
      ...
      foreach(char c in texto) {
        textoCifrado += Char.ConvertFromUtf32((int)c+keyCifra);
      }
